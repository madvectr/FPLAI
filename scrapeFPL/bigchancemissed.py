...
async def fetch_data_for_season(session, comp_season_id, season_name):
    ...
    while True:
        api_url = f"https://footballapi.pulselive.com/football/stats/ranked/players/big_chance_missed?page={page_number}&pageSize={page_size}&compSeasons={comp_season_id}&comps=1&compCodeForActivePlayer=EN_PR&altIds=true"
        ...
        async with session.get(api_url, headers=headers) as response:
            ...
            for player_data in stats:
                ...
                player_row = {
                    ...
                    'BigChanceMissed': player_data.get('value', '-1'),
                    'Age': owner.get('age', '-1'),
